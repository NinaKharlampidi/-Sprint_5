...
class TestRegistrationForm:
    ...
    def test_double_registration_check_error(self, driver):
        ...
        assert (error == 'Такой пользователь уже существует') and (driver.current_url == 'https://stellarburgers.nomoreparties.site/register')
    ...
    def test_registration_incorrect_password_check_error(self, driver):
        ...
        assert (error == 'Некорректный пароль') and (driver.current_url == 'https://stellarburgers.nomoreparties.site/register')
